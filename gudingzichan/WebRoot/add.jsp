...
<html>
  ...
  <body style="background-color: #9ad2b2;">
     ...
     <form action="executeAdd.action" method="post">
       <table border="1" align="center", width="80%">
            ...
            <tr>
                <td>使用部门</td>
                <td>
                	<!--select id="xiala" style="display: block;">
                		<s:iterator value="listzichan">
                			<option value="<s:property value="deptname"/>"><s:property value="deptname"/></option>
                		</s:iterator>
	    			</select-->
  ...
  <script type="text/javascript">	
		...
		function getTypeLike(){
			if($("#typename").val()==""){
				...
				$.ajax({
            	url: "queryTypeLike.action?zichan.typename="+$("#typename").val(),
            	type: "get",
            	success: function (msg) {
            		//alert(msg);
                	//$("#zichanId").val(msg);
